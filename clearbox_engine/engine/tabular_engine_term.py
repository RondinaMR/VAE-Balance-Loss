...
from clearbox_engine.VAE.tabular_vae_term import TabularVAETerm, eval, train_step
from .engine import EngineInterface

import logging

# create logger
module_logger = logging.getLogger('engine.tabular_engine_term')


class TabularEngineTerm(EngineInterface):
    model: TabularVAETerm
    params: FrozenDict
    search_params: Dict
    architecture = Dict
    ...
    def __init__(
        ...
        self.logger = logging.getLogger('engine.tabular_engine_simpsonized.TabularEngineTerm')
        self.logger.info('creating an instance of TabularEngineTerm')
